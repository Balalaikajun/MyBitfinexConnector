...
namespace MyBitfinexConnector.Bitfinex.Tests.Integration.REST;
...
public class BitfinexRestClient_Tests
{
    ...
    public async Task GetTradesAsync_LimitIsWork()
    {
        ...
        var trades = await _client.GetTradesAsync(Pair, limit);
    ...
    public async Task GetTradesAsync_LimitFromToIsWork()
    {
        ...
        var trades = await _client.GetTradesAsync(Pair, limit, from, to);
